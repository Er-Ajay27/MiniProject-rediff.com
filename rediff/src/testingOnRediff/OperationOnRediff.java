...
public class OperationOnRediff {
	 ...
	 * 
	 * // ReadWriteFromExcel rw = new ReadWriteFromExcel(); String File1 =
	 * "Product.xlsx"; String name =
	 * rw.read(File1).getRow(1).getCell(0).getStringCellValue(); String emailid =
	 * rw.read(File1).getRow(1).getCell(1).getStringCellValue(); String password =
	 * rw.read(File1).getRow(1).getCell(2).getStringCellValue(); String repassword =
	 * rw.read(File1).getRow(1).getCell(3).getStringCellValue();
	 * 
	 * int dateDay = (int)
	 * rw.read(File1).getRow(1).getCell(4).getNumericCellValue(); String dateMonth=
	 * rw.read(File1).getRow(1).getCell(5).getStringCellValue(); int dateYear =
	 * (int) rw.read(File1).getRow(1).getCell(6).getNumericCellValue(); Integer y =
	 * new Integer(dateYear); String year = y.toString(); String country =
	 * rw.read(File1).getRow(1).getCell(7).getStringCellValue(); String city =
	 * rw.read(File1).getRow(1).getCell(8).getStringCellValue();
	 * 
	 ...
	 * Thread.sleep(2000);
	 * driver.findElement(By.xpath("//input[@name='repass']")).sendKeys(repassword);
	 * Thread.sleep(3000);
	 * 
	 * WebElement da =
	 * driver.findElement(By.xpath("//select[@name='date_day']"));//day Select date1
	 * = new Select(da); date1.selectByIndex(dateDay); Thread.sleep(3000);
	 * 
	 * da = driver.findElement(By.id("date_mon")); date1 = new Select(da);
	 * date1.selectByVisibleText(dateMonth); Thread.sleep(3000);
	 * 
	 * da = driver.findElement(By.xpath("//select[@name='Date_Year']"));//year date1
	 * = new Select(da); date1.selectByVisibleText(year); Thread.sleep(3000);
	 * 
	 * driver.findElement(By.xpath("//input[@value='m']")).click();
	 * Thread.sleep(3000);
	 * 
	 * da = driver.findElement(By.xpath("//select[@name='country']")); date1 = new
	 * Select(da); date1.selectByVisibleText(country); Thread.sleep(3000);
	 * 
	 * da = driver.findElement(By.xpath("//select[@name='city']")); date1 = new
	 * Select(da); date1.selectByVisibleText(city); Thread.sleep(3000);
	 * 
	 * driver.findElement(By.xpath("//input[@value='Submit']")).click(); }
	 */
}
